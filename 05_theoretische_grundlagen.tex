...
Das Ergebnis der Update-Funktion wird weitergereicht an die $View$-Funktion. Sie beschreibt das Aussehen der Webseite und kümmert sich um die Darstellung des $Model$s. Elm nutzt ein virtuelles \ac{DOM}, wodurch nur tatsächliche Änderungen im Browser angezeigt werden, anstatt dauerhaft das komplette \ac{DOM} stetig zu aktualisieren.
%Document Object Model (DOM) ist eine plattform- sowie sprachenunabhängige Schnittstellenbeschreibung für den Zugriff auf die Elemente eines HTML- oder XML-Dokuments. (http://www.itwissen.info/definition/lexikon/document-object-model-DOM.html)
Das \ac{DOM} beschreibt die Schnittstelle zum Datenzugriff auf das Objektmodell eines \ac{HTML}-Dokumentes.
...
Oftmals sind externe Bibliotheken nicht deklarativ programmiert, weswegen keinerlei Garantien seitens Elm gemacht werden können. Jedoch gibt Elm an, dass der Datenaustausch über isolierte Ports in beide Richtungen funktioniert.
...
%TODO: (https://www.youtube.com/watch?v=zBHB9i8e3Kc).
...
Auf der offiziellen Webseite von Elm wird angegeben, dass Elm die beste funktionale Programmiersprache des Browsers sei.
%TODO: "the best of functional programming in your browser"
Diese Aussage wird anhand der Entwicklung, respektive der Überführung einer Webseite in nativen Elm überprüft. Die Evaluierung erfolgt schließlich anhand einiger Bewertungskriterien.
